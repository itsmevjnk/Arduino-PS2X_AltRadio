...
#ifndef ps2_si4432_H_
#define ps2_si4432_H_
#include "Arduino.h"
#include <SPI.h>
...
public:
	...
	uint8_t getPacketReceived(uint8_t* length, byte* readData); // read from FIFO
...
protected:
	...
	uint64_t _freqCarrier = 433000000;
	uint8_t _freqChannel = 0;
	uint16_t _kbps = 100;
	uint16_t _packageSign = 0xDEAD;
